...
class TravelDocDriverPage extends StatefulWidget {
  const TravelDocDriverPage({Key? key}) : super(key: key);

  @override
  _TravelDocDriverPageState createState() => _TravelDocDriverPageState();
}

class _TravelDocDriverPageState extends State<TravelDocDriverPage> {
  ...
  goingToDetailPage(String id) async {
    ...
    var result = await Navigator.push(context,
        MaterialPageRoute(builder: (context) => TravelDocDetailDriverPage()));
