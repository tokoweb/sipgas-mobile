...
class SearchTravelDocWerehousePage extends StatefulWidget {
  const SearchTravelDocWerehousePage({Key? key}) : super(key: key);

  @override
  _SearchTravelDocWerehousePageState createState() =>
      _SearchTravelDocWerehousePageState();
}

class _SearchTravelDocWerehousePageState
    extends State<SearchTravelDocWerehousePage> {
  ...
  goingToDetailPage(String id) async {
    ...
    await Navigator.push(context,
        MaterialPageRoute(builder: (context) => TravelDocDetailWerehousePage()));
  }
